...
public sealed class Datc64DraftApplyService
{
    ...
    private readonly Func<string, CancellationToken, Task<Datc64DraftResourceReadResult>> _readResourceAsync;
        ...
        CancellationToken cancellationToken)
    {
        ...
        var read = await _readResourceAsync(proposal.ResourcePath, cancellationToken);
